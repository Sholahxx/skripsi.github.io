...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#nilai_r">
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-table"></i> Bobot Kriteria <?= $key->keterangan ?></h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-table"></i> Nilai Normalisasi Bobot Kriteria</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-table"></i> Nilai Distance Score</h6>
    </div>
